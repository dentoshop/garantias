...
with empp:
    ...
    if passw==st.secrets["password"]:
        ...
        with tab1:
            ...
            valores=[id,fecha_ing1.strftime("%d-%B-%Y"),Nom_Apell,Dni,Ruc,Num,Email,Num_sn,Nom_Equip,Accesorios,Obs,Motivo,"",monto_pago,"Recepcion",0,"No","","","","","",'']
        ...
        #############################################
            ...
            fecha_mod=pd.to_datetime(fecha_mod).strftime("%d-%B-%Y")
